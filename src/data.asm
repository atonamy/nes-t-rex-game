...
; ---------------------------------------------------------------------------
jump_vel_lo:
        .byte $66, $4D, $33, $1A, $00, $E6, $CD, $B3
jump_vel_hi:
        .byte $F5, $F5, $F5, $F5, $F5, $F4, $F4, $F4
        ; vy = -(10 + speed/10), 8.8 two's complement:
        ; -10.6=$F566 -10.7=$F54D -10.8=$F533 -10.9=$F51A
        ; -11.0=$F500 -11.1=$F4E6 -11.2=$F4CD -11.3=$F4B3
